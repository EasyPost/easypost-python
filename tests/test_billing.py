...
@patch("easypost.services.billing_service.Requestor.request", return_value=[{"mock": "response"}, "mock-api-key"])
...
@patch("easypost.services.billing_service.Requestor.request", return_value=[{"id": "card_123"}, "mock-api-key"])
