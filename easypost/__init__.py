...
CARRIER_CHOICES = (
    ('AGSystems', 'Associated Global Systems'),
    ('AmazonMws', 'AmazonMws'),
    ('APC', 'APC'),
    ('Aramex', 'Aramex'),
    ('ArrowXL', 'ArrowXL'),
    ...
    ('Correios', 'Correios'),
    ('CorreosChile', 'Correos Chile'),
    ('CorreosCostaRica', 'Correos Costa Rica'),
    ('Delhivery', 'Delhivery'),
    ('Deliv', 'Deliv'),
    ...
    ('DHLGlobalmailInternational', 'DHL GM International'),
    ('Dicom', 'Dicom'),
    ...
    ('InternationalBridge', 'International Bridge'),
    ...
    ('USFHolland', 'USF Holland'),
    ('USPS', 'USPS'),
    ('WatkinsAndShepard', 'Watkins & Shepard'),
    ('wnDirect', 'wnDirect'),
    ('Yanwen', 'Yanwen'),
    ('Yodel', 'Yodel'),
