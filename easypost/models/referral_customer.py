...
class ReferralCustomer(EasyPostObject):
...
class ReferralCustomerCollection(PaginatedCollection):
    referral_customers: List[ReferralCustomer] = Field([], alias="referral_customers")
